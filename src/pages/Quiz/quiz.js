...
const Quiz = () => {
  ...
  return (
    <div>
      {Quiz.map((questchoi, id) => {
        return (
          <div key={id}>
            ...
            <div>
              {hide ? 
              <input  name="edit" value={choice1} onChange={(e) => setchoice1(e.target.value) }/> 
              : null}
              {hide ? <button type="button" onClick={() => {editChoice1(questchoi.id,questchoi.choice1)}}>
                Edit Choice1
              </button>: null}
            </div>
              <br></br>
            ...
            <div>
              {hide ? 
              <input  name="edit" value={choice2} onChange={(e) => setchoice2(e.target.value) }/> 
              : null}
              {hide ? <button type="button" onClick={() => {editChoice2(questchoi.id,questchoi.choice2)}}>
                Edit Choice2
              </button>: null}
            </div>
                <br></br>
            ...
            <div>
              {hide ? 
              <input  name="edit" value={choice3} onChange={(e) => setchoice3(e.target.value) }/> 
              : null}
              {hide ? <button type="button" onClick={() => {editChoice3(questchoi.id,questchoi.choice3)}}>
                Edit Choice3
              </button>: null}
            </div>
                <br></br>
            ...
            <div>
              {hide ? 
              <input  name="edit" value={choice4} onChange={(e) => setchoice4(e.target.value) }/> 
              : null}
              {hide ? <button type="button" onClick={() => {editChoice4(questchoi.id,questchoi.choice4)}}>
                Edit Choice4
              </button>: null}
            </div>
                <br></br>
            <div>
              {hide ? 
              <input  name="edit" value={question} onChange={(e) => setquestion(e.target.value) }/> 
              : null}
              {hide ? <button type="button" onClick={() => {editQuest(questchoi.id,questchoi.question)}}>
                Edit Question
              </button>: null}
            </div>
      ...
      <button onClick={() => sethide(!hide)}>Click to edit question</button>
    </div>
  );
};
